...
{
    /// <summary>
    /// Interface for trading operations, including order placement, management, position handling, and trade history retrieval.
    /// Provides methods for interacting with trading endpoints, managing orders, positions, and retrieving trade-related data.
    /// </summary>
    public interface ITradeClient
    {
        ...
        Task<ApiResult<Transaction[]>> GetUserTradeAsync(string? symbol = null, string? underlying = null, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, CancellationToken ct = default);
        ...
        /// <summary>
        /// Sets the Magic Number to identify the order source (e.g., from Bot A, Bot B).
        /// </summary>
        /// <param name="magicNumber">The magic number string.</param>
